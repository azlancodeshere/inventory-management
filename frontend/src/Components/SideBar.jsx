        ...
        <aside className="hidden md:flex w-64 min-h-[calc(100vh-64px)] bg-white border-r border-gray-200 flex-col justify-between p-4">
            ...
            <div>
                ...
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg mb-1 ${location.pathname === "/all-products"
                            ? "bg-black text-white"
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-gray-600 hover:bg-gray-100 mb-1">
                    <Tags size={19} />
                    <span className="text-sm font-medium">
                        Categories
                    </span>
